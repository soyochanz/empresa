...
export default function CalendarScreen({ 
  ...
  const handleAddEventSubmit = (e: React.FormEvent) => {
    ...
    const toast = document.getElementById('toast-msg');
    if (toast) {
      toast.innerText = `Evento creado: ${generatedEvent.title}`;
      toast.classList.remove('opacity-0');
            ...
            <form onSubmit={handleAddEventSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <input 
                  type="text"
                  required
                  placeholder="e.g. Design Sync & UI Review"
                  value={newTitle}
              ...
              {newType === 'Meeting' && (
                <div className="space-y-1 animate-in slide-in-from-top-2 duration-150">
                  <label className="text-[10px] font-mono text-blue-400 uppercase tracking-wider font-semibold">Meeting Video Link (Google Meet / Zoom etc.)</label>
                  <input 
                    type="url"
