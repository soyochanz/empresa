...
<head>
 ...
 <style>
  ...
  .invoice{width:210mm;min-height:297mm;margin:0 auto;padding:18mm;background:#fff}
  ...
  @media(max-width:800px){.invoice{width:100%;min-height:100vh;padding:25px}.header,.parties{display:block}.invoice-meta{text-align:left;margin-top:25px}.parties .box{margin-top:12px}.bank-grid{grid-template-columns:1fr}}
  @media print{.invoice{width:210mm;min-height:297mm;padding:18mm}}
 </style>
</head>
<body>
 <main class="invoice">
