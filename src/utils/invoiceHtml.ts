...
<head>
 ...
 <style>
  ...
  .item-status{display:inline-block;margin-left:7px;padding:2px 6px;border:1px solid #f5d98b;border-radius:999px;background:#fffbeb;color:#a16207;font-size:7px;font-weight:800;letter-spacing:.05em;vertical-align:middle}
